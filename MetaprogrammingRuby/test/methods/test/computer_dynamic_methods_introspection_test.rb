...
require 'pry-byebug'
require_relative '../lib/computer_dynamic_methods_introspection'

class ComputerDynamicMethodsIntrospectionTest < Minitest::Test
  attr_reader :computer

  def setup
    @computer = ComputerDynamicMethodsIntrospection.new(42, DataSource.new)
  end
